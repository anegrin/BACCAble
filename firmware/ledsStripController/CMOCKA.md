...
rm -f build/*;gcc -DDASHBOARD_MESSAGE_MAX_LENGTH=18 -DPRINTF_INCLUDE_CONFIG_H -ICore/Inc/ Core/Src/printf.c Core/Src/uart_proto.c Test/Src/test_uart.c -o build/test_uart -l:libcmocka.a; ./build/test_uart
