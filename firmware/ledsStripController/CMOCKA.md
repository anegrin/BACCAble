...
rm -f build/test*;gcc -DPRINTF_INCLUDE_CONFIG_H -DBHbaccable -ICore/Inc/ Core/Src/printf.c Core/Src/dashboard.c Test/Src/test_dashboard.c -o build/test_dashboard -l:libcmocka.a; ./build/test_dashboard
