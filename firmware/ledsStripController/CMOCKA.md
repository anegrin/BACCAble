...
rm -f build/*;gcc -DPRINTF_INCLUDE_CONFIG_H -ICore/Inc/ Core/Src/printf.c Core/Src/uart_helper.c Test/Src/test_uart.c -o build/test_uart -l:libcmocka.a; ./build/test_uart
...
osx:
rm -f build/test*;gcc -DPRINTF_INCLUDE_CONFIG_H -ICore/Inc/ Core/Src/printf.c Core/Src/uart_helper.c Test/Src/test_uart.c -o build/test_uart -L$(brew --prefix cmocka)/lib -lcmocka; ./build/test_uart
